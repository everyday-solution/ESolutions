...
namespace ESolutions.Core.Test
{
	...
	public class DateTimeExtenderTests
	{
		...
		public void TestHolidaysInBerlin()
		{
			...
			Assert.True(actual2020Berlin.ContainsKey(new DateTime(2020, 5, 8))); // 75. Jahrestags der Kapitulation der Wehrmacht
			...
			Assert.True(actual2025Berlin.ContainsKey(new DateTime(2025, 5, 8))); // 80. Jahrestags der Kapitulation der Wehrmacht
			...
			Assert.True(actual2028Berlin.ContainsKey(new DateTime(2028, 6, 17))); // 75. Jahrestag des Volksaufstandes der DDR
		}
		#endregion
